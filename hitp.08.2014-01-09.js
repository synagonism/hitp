/*
 * version.8.last.minor: hitp.js (2014.01.09.8 minor 2014.01.09.8.1)
 * version.8.last: hitp.2014.01.09.8.js (toc on hovering)
...
//      eltTab2ContentDiv = document.createElement('div'),
    ...
    eltPNote.innerHTML = '<span class="color-green style-b">Notes</span>: <br/>a) Clicking on ¶, you see its address on address-bar. <br/>b) hovering a piece of text, you see its position on ToC. <br/>c) hovering a domain-link you see a preview.';
